...
const dict = {
  de: {
    ...
    'nav.statistiken': 'Statistiken',
    'nav.sportler': 'Meine Profile',
    'nav.export': 'Export',
    ...
    'competition.scoreSheet': 'Wettkampf erfassen',
    'competition.editTitle': 'Wettkampf bearbeiten',
    ...
    'athletes.editorFirstName': 'Vorname',
    'athletes.editorFirstNamePlaceholder': 'Vorname',
    'athletes.editorLastName': 'Nachname',
    'athletes.editorLastNamePlaceholder': 'Nachname',
    'athletes.club': 'Verein',
    'athletes.clubPlaceholder': 'z. B. RKV Denkendorf',
    'athletes.clubFooter': 'Tippen und aus den Vorschlägen wählen — oder frei eingeben, wenn dein Verein nicht dabei ist.',

    'teams.section': 'Teams',
    'teams.new': 'Team',
    'teams.join': 'Beitreten',
    'teams.empty': 'Noch keine Teams. Lege eine Formation (2er/4er/6er) an oder tritt per Code bei.',
    'teams.memberOne': 'Mitglied',
    'teams.memberMany': 'Mitglieder',
    'teams.newTitle': 'Team anlegen',
    'teams.editTitle': 'Team bearbeiten',
    'teams.name': 'Name',
    'teams.namePlaceholder': 'z. B. 4er Aach',
    'teams.discipline': 'Formation',
    'teams.members': 'Mitglieder',
    'teams.noMembers': 'Noch keine Mitglieder.',
    'teams.captain': 'Captain',
    'teams.addMember': 'Mitglied hinzufügen',
    'teams.addMemberFooter': 'Du kannst Sportler hinzufügen, die du verwaltest. Andere treten per Beitritts-Code bei.',
    'teams.searchAthlete': 'Sportler suchen',
    'teams.noCandidates': 'Keine passenden Sportler.',
    'teams.joinCode': 'Beitritts-Code',
    'teams.joinCodeFooter': 'Mit diesem Code treten Sportler dem Team selbst bei (Sportler-Tab → Beitreten).',
    'teams.noJoinCode': 'Noch kein Code',
    'teams.newCode': 'Neuer Code',
    'teams.createCode': 'Code erstellen',
    'teams.viewData': 'Team-Daten ansehen',
    'teams.delete': 'Team löschen',
    'teams.unknownMember': 'Unbekannt',
    'teams.joinTitle': 'Team beitreten',
    'teams.joinHint': 'Gib den Beitritts-Code ein, den du von deinem Team oder Trainer bekommen hast.',
    ...
    'pdfImport.bannerTitle': 'Wertungsbericht importieren',
    ...
    'settings.role': 'Rolle',
    'settings.license': 'Lizenznummer',
    'settings.licensePlaceholder': 'z. B. 1234567',
    ...
    'pw.new': 'Neues Passwort (min. 10)',
    'pw.confirm': 'Passwort wiederholen',
    'pw.mismatch': 'Passwörter stimmen nicht überein.',
    'pw.tooShort': 'Mindestens 10 Zeichen.',
    ...
    'export.openButton': 'Daten exportieren',
  ...
  en: {
    ...
    'nav.statistiken': 'Statistics',
    'nav.sportler': 'My profiles',
    'nav.export': 'Export',
    ...
    'athletes.editorFirstName': 'First name',
    'athletes.editorFirstNamePlaceholder': 'First name',
    'athletes.editorLastName': 'Last name',
    'athletes.editorLastNamePlaceholder': 'Last name',
    'athletes.club': 'Club',
    'athletes.clubPlaceholder': 'e.g. RKV Denkendorf',
    'athletes.clubFooter': 'Type and pick from suggestions — or enter freely if your club is not listed.',

    'teams.section': 'Teams',
    'teams.new': 'Team',
    'teams.join': 'Join',
    'teams.empty': 'No teams yet. Create a formation (2er/4er/6er) or join with a code.',
    'teams.memberOne': 'member',
    'teams.memberMany': 'members',
    'teams.newTitle': 'New team',
    'teams.editTitle': 'Edit team',
    'teams.name': 'Name',
    'teams.namePlaceholder': 'e.g. 4er Aach',
    'teams.discipline': 'Formation',
    'teams.members': 'Members',
    'teams.noMembers': 'No members yet.',
    'teams.captain': 'Captain',
    'teams.addMember': 'Add member',
    'teams.addMemberFooter': 'You can add athletes you manage. Others join with a join code.',
    'teams.searchAthlete': 'Search athlete',
    'teams.noCandidates': 'No matching athletes.',
    'teams.joinCode': 'Join code',
    'teams.joinCodeFooter': 'Athletes use this code to join the team themselves (Athletes tab → Join).',
    'teams.noJoinCode': 'No code yet',
    'teams.newCode': 'New code',
    'teams.createCode': 'Create code',
    'teams.viewData': 'Open team data',
    'teams.delete': 'Delete team',
    'teams.unknownMember': 'Unknown',
    'teams.joinTitle': 'Join team',
    'teams.joinHint': 'Enter the join code you received from your team or coach.',
    ...
    'pdfImport.bannerTitle': 'Import score report',
    ...
    'settings.role': 'Role',
    'settings.license': 'License number',
    'settings.licensePlaceholder': 'e.g. 1234567',
    'settings.cloudSync': 'Cloud sync',
    ...
    'pw.new': 'New password (min. 10)',
    'pw.confirm': 'Repeat password',
    'pw.mismatch': 'Passwords do not match.',
    'pw.tooShort': 'At least 10 characters.',
  ...
  fr: {
    ...
    'nav.statistiken': 'Statistiques',
    'nav.sportler': 'Mes profils',
    'nav.export': 'Exporter',
    ...
    'pw.new': 'Nouveau mot de passe (min. 10)',
    'pw.confirm': 'Répéter le mot de passe',
    'pw.mismatch': 'Les mots de passe ne correspondent pas.',
    'pw.tooShort': 'Au moins 10 caractères.',
  ...
  it: {
    ...
    'nav.statistiken': 'Statistiche',
    'nav.sportler': 'I miei profili',
    'nav.export': 'Esporta',
    ...
    'pw.new': 'Nuova password (min. 10)',
    'pw.confirm': 'Ripeti password',
    'pw.mismatch': 'Le password non corrispondono.',
    'pw.tooShort': 'Almeno 10 caratteri.',
    'pw.changed': 'Password modificata.',
    'pw.failed': 'Modifica non riuscita.',
    'pw.save': 'Salva password',
  ...
  es: {
    ...
    'nav.statistiken': 'Estadísticas',
    'nav.sportler': 'Mis perfiles',
    'nav.export': 'Exportar',
    ...
    'pw.new': 'Nueva contraseña (mín. 10)',
    'pw.confirm': 'Repetir contraseña',
    'pw.mismatch': 'Las contraseñas no coinciden.',
    'pw.tooShort': 'Al menos 10 caracteres.',
    'pw.changed': 'Contraseña cambiada.',
    'pw.failed': 'Error al cambiar.',
    'pw.save': 'Guardar contraseña',
  ...
  cs: {
    ...
    'nav.wettkampf': 'Závod',
    'nav.uebungen': 'Cviky',
    'nav.statistiken': 'Statistiky',
    'nav.sportler': 'Moje profily',
    'nav.export': 'Export',
    ...
    'pw.new': 'Nové heslo (min. 10)',
    'pw.confirm': 'Zopakovat heslo',
    'pw.mismatch': 'Hesla se neshodují.',
    'pw.tooShort': 'Alespoň 10 znaků.',
    'pw.changed': 'Heslo změněno.',
    'pw.failed': 'Změna se nezdařila.',
    'pw.save': 'Uložit heslo',
  ...
  hu: {
    ...
    'nav.statistiken': 'Statisztikák',
    'nav.sportler': 'Profiljaim',
